               ...
               <div class="card-body">
                  <h5 class="card-title">Enunciado </h5>
                    <p class="card-text"> – Crear un formulario que permita subir un archivo. En el servidor se deberá controlar 
                        ...
                        contenido en un textarea. (OBS: Referencia a funciones para trabajar con archivos http://php.net/manual/en/ref.filesystem.php) 
                       <form  id="eje2" name="eje2" method="POST" action="accion.php" enctype="multipart/form-data">
                         ...
                         <label for="archivo" class="form-label"> <b> Subir archivo: txt (texto plano) </b></label>
                            <input type="file" accept=".txt" class="form-control input-group w-50" id="archivo" name="archivo" size="100" placeholder="Seleccionar archivo"required> 
